...
# Note that we prefer uint to int when both are equally precise. For example,
# for 5, we pick uint8 instead of int8. There is no obvious reason to prefer one
# to the other, so we just chose one.
